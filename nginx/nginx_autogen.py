...
"""
site_template_start_nossl = """# This site was generated by nginx_autogen.py at https://github.com/ClicksMinutePer/utilities/blob/master/nginx/nginx_autogen.py
server {{
...
"""
site_template_start_ssl = """# This site was generated by nginx_autogen.py at https://github.com/ClicksMinutePer/utilities/blob/master/nginx/nginx_autogen.py
server {{
    server_name {domains} {www_domains};
    access_log /var/log/nginx/{primary}-access.log;
    error_log /var/log/nginx/{primary}-error.log;
